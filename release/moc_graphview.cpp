...
QT_MOC_LITERAL(1, 10, 12), // "focusChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 11), // "scalingTime"
QT_MOC_LITERAL(4, 36, 12), // "animFinished"
QT_MOC_LITERAL(5, 49, 18) // "handleNewSelection"

    },
    "GraphView\0focusChanged\0\0scalingTime\0"
    "animFinished\0handleNewSelection"
};
...
void GraphView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->handleNewSelection(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphView::focusChanged)) {
                *result = 0;
                return;
            }
        }
